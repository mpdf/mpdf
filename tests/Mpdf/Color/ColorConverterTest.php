...
class ColorConverterTest extends \Yoast\PHPUnitPolyfills\TestCases\TestCase
{
    ...
    public static function convertColorsProvider()
    {
        return [
    ...
    public static function colAtoStringProvider()
    {
        return [
    ...
    public static function lightenColorsProvider()
    {
        return [
    ...
    public static function darkenColorsProvider()
    {
        return [
    ...
    public static function invertColorsProvider()
    {
        return [
