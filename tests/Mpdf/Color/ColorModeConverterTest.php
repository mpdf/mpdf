...
class ColorModeConverterTest extends \Yoast\PHPUnitPolyfills\TestCases\TestCase
{
    ...
    public static function hsl2rgbProvider()
    {
        return [
    ...
    public static function rgb2hslProvider()
    {
        return [
    ...
    public static function rgb2grayProvider()
    {
        return [
    ...
    public static function cmyk2grayProvider()
    {
        return [
    ...
    public static function rgb2cmykProvider()
    {
        return [
    ...
    public static function cmyk2rgbProvider()
    {
        return [
    ...
    public static function hue2rgbProvider()
    {
        return [
